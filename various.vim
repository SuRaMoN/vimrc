...
let g:ale_php_phpstan_configuration = 'tests/PHPstan/level8.neon --autoload-file=tests/PHPstan/autoload.php --error-format icontroller_raw'
...
let g:ale_php_phpcs_options = '--extensions=php,phtml --exclude=Generic.Commenting.Todo,Icontroller.Annotations.BlacklistedAnnotations'
...
function! CtagsLoad()
    exec ':Dispatch! ctags -R --fields=+aimlS --exclude=bin/composer.phar --languages=php --kinds-php=-lvan -f tags_new; mv tags_new tags'
endfunction
