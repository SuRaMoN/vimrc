...
function! phpcomplete#getVimAutoCompleteFileValue(forClass)
	let g:vimAutoCompleteFileCache = {}
	...
	if has_key(g:vimAutoCompleteFileCache, a:forClass)
		return g:vimAutoCompleteFileCache[a:forClass]
	endif
	...
	elseif scontext =~ '\(->\|::\)$'
		...
		if scontext =~ '->$' || scontext =~ '::'
			...
			if filereadable(classlocation)
				...
				for func in phpcomplete#getVimAutoCompleteFileValue(classname)
					call extend(all_values, func)
				endfor
